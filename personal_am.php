...
<html>
     <head>
        <title>Airmen | Leave application</title>
                ...
                <div class="panel panel-primary">
                    ...
                    <form role="form" action="signup_script.php" method="POST">
                        <div class="form-group">
                            <h5><b>Service No.(With Sx)</b></h5> <input type="text" class="form-control" placeholder="Ex: 123456A" name="serNo"   required maxlength="7" pattern="[0-9]{6}[A-Z]{1}" title="Must be of 6 numbers followed by an alphabet" >
                        </div>
                        <div class="form-group">
                                <h5><b>Rank</b></h5>
                                <select name="rank">
                                    <option>--Select--</option>
                                    <option value="hfl">Hony.Flt Lt</option>
                                    <option value="hfo">Hony.Fg Offr</option>
                        ...
                        <div class="form-group">
                            <h5><b>Name</b></h5><input type="text" class="form-control" placeholder="Ex: Ram Singh" name="name" required = "true" pattern="[A-Z]" title="Enter a valid name">
                        </div>
                           <div class="form-group">
                               <h5><b>Trade</b></h5>
                           ...
                           <div class="form-group">
                               <h5><b>Unit</b></h5><input  type="text" class="form-control"  placeholder="Ex:112HU" name="unit" required = "true" title="Enter a valid input">
                           </div>
                           <div class="form-group">
                               <h5><b>Basic Pay</b></h5>  <input  type="text" class="form-control"  placeholder="Ex:10000" name="bpay" required = "true" title="Enter a valid input">
                           </div>
                           <div class="form-group">
                                <h5><b>Rly Stn(Home Town)</b></h5>  <input  type="text" class="form-control"  placeholder="Ex:NDLS" name="address" required = "true" pattern="[A-Z]" title="Enter a valid input">
                           </div>
