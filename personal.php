                    ...
                    <div class="panel-body">
                       ...
                       <form role="form" action="signup_script.php" method="POST">
                        <div class="form-group">
                            <h5><b>Service No.(With Sx)</b></h5> <input type="text" class="form-control" placeholder="Ex: 12345A" name="serNo" pattern="[0-9]{5}[A-Z]{1}" required maxlength="6" minlength="6">
                        </div>
                        <div class="form-group">
                                <h5><b>Rank</b></h5>
                                <select name="rank">
                        ...
                        <div class="form-group">
                            <h5><b>Name</b></h5><input type="text" class="form-control" placeholder="Ex: Ram Singh" name="name" required = "true" pattern="[a-zA-Z\s]{1,}">
                        </div>
                           ...
                           <div class="form-group" style="text-transform: uppercase;">
                                <h5><b>Rly Stn(Home Town)</b></h5>  <input  type="text" class="form-control"  placeholder="Ex:NDLS" name="address" required = "true" pattern="[A-Z]{1,}">
                           </div>
